...
select
    view_promo_started_at,
    profile_id,
    session_id,
    view_promo_first_seen_at,
    view_promo_time_session_ms,
    view_promo_count,
    device_type,
    device_brand,
    device_model,
    ...
    platform,
    view_promo_landing_page_title,
    view_promo_landing_page_url,
    view_promo_page_referrer,
...
from (
    select
        ...
        ev.engagement_time_msec as view_promo_time_session_ms,
        ev.page_title as view_promo_landing_page_title,
        ev.page_location as view_promo_landing_page_url,
        ev.ga_session_id as session_id,
        ev.page_referrer as view_promo_page_referrer,
